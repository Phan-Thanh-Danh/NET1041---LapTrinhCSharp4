        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 1, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, 2, new DateTime(2025, 2, 3, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });

            migrationBuilder.InsertData(
                table: "Dishes",
                columns: new[] { "DishId", "Name", "OrderId" },
                values: new object[,]
                {
                    { 1, "Pizza Margherita", 1 },
                    { 2, "Spaghetti Carbonara", 1 },
                    { 3, "Grilled Salmon", 2 },
                    { 4, "Caesar Salad", 3 },
                    { 5, "Beef Steak", 3 }
                });
